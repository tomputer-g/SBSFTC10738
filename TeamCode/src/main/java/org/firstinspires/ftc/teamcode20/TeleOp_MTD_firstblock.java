...
public class TeleOp_MTD_firstblock extends BaseAuto {
    ...
    private double groundHeightEnc = (2.25+1.18) * slideEncoderPerInch;//1 higher placing + 1.25 base height
    Servo france;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if (!this.gamepad1.right_bumper && rb) {
                rb = false;
                if (servoThread.lastPosition > (grabberServoOutFirstBlock + grabberServoIn) / 2) {
                    servoThread.setTarget(grabberServoOutFirstBlock);
                } else {
