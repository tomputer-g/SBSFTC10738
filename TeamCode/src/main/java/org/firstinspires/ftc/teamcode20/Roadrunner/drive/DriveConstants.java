...
public class DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 1.96852;//inches (100mm - Tom used have 2 inches - I changed it [sgw])
    public static double GEAR_RATIO = 8.0/14.0; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 12.992126;//12.992126 inches (330 mm)
