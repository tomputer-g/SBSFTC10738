...
@Disabled
public class AutoRedCraterSS_MF extends BaseAuto {
    ...
    public void loop(){
        ...
        switch(TFOD_result) {
            case 0:
                ...
                moveInchesHighSpeedEncoder(10, 0, 0.2, 2, 4, 0.1, 0.3, 0.1);
                moveInchesHighSpeedEncoder(0, -19, 0.4, 4, 4, 0.1, 0.55, 0.15);
                break;
            case 1:
        ...
        moveInchesHighSpeedEncoder(0, - XOffset, 0.5, 4,8,0.2,0.4,0.15);
        ...
        // Move back to Vumark.
        if (TFOD_result == 2.75) {
            moveInchesHighSpeedEncoder(0, XOffset - 5, 0.75, 5, 4, 0.3, 0.4, 0.08);
            moveInchesHighSpeedEncoder(-YOffset, 0, 0.2, 2, 2, 0.15, 0.45, 0.15);
        }
        else{
            moveInchesHighSpeedEncoder(0, XOffset - 2, 0.75, 5, 4, 0.3, 0.4, 0.08);
            moveInchesHighSpeedEncoder(-YOffset, 0, 0.2, 2, 2, 0.15, 0.45, 0.15);
        }
        ...
        if (vumarkIsVisible()) {
            ...
            if (Math.abs(turningAmount-42.25) > 15)
            {
                turningAmount = 42.25;
        ...
        moveInchesHighSpeedEncoder(30,0,0.6,6,12,0.1,0.55,0.1);
