...
public class BaseOpMode extends OpMode {
    ...
    protected RevTouchSensor slideLimitSW;
    protected DcMotor LF, LB, RF, RB, grabber_shoulder, grabber_slide, lander_lifter, grabber;
    protected Servo light, hatch;
    ...
    protected void initGrabber(){
        ...
        hatch = hardwareMap.get(Servo.class, "sorter_hatch");
    }

    protected void initLifter(){
        lander_lifter = hardwareMap.get(DcMotor.class, "lifter");
        lander_lifter.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        lander_lifter.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
        lander_lifter.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
