...
public class AutoRedCraterDS_SF extends BaseAuto {
    ...
    public void loop(){
        ...
        switch(TFOD_result) {
            case 0:
                ...
                moveInchesHighSpeedEncoder(32,0,0.5,3,6,0.2,0.3,0.1);
                moveInchesHighSpeedEncoder(-31,0,0.5,3,6,0.2,0.3,0.1);
                break;
            case 1:
                // Push alliance mineral and come back
